...
--
-- Host: localhost
-- Generation Time: Apr 08, 2020 at 08:15 PM
...
(2, 'pedro', 'pedro@gmail.com', 'lo mejor del mundo'),
(3, 'jorge', 'jorge@gmail.com', 'volvere pronto , experiencia inovidable '),
(4, 'melmelada', 'melmelada@gmail.com', 'making it look like readable English. Many desktop publishing packages and web page editors now use Lorem Ipsum as their default model text, and a search for \'lorem ipsum\' will uncover many web sites still in their infancy. Various versions have evolved over the years, sometimes by accident, sometimes on purpose (injected humour and the like).'),
(5, 'Edison J. Padilla', 'EIDID@GMAIL.COM', 'making it look like readable English. Many desktop publishing packages and web page editors now use Lorem Ipsum as their default model text, and a search for \'lorem ipsum\' will uncover many web sites still in their infancy. Various versions have evolved over the years, sometimes by accident, sometimes on purpose (injected humour and the like).\r\n'),
(6, 'los pepes', 'pepe@gmail.com', 'pepe the best '),
(7, 'jarro', 'jarro@gmail.com', 'probando async / await'),
(9, 'reinesle', 'dkdkskksks@gmail.com', 'jojojojoj');
